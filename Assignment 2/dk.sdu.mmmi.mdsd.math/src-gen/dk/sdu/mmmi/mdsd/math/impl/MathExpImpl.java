...
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
   ...
   * @ordered
   */
  protected EList<Declaration> variables;
   ...
   */
  @Override
  public EList<Declaration> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<Declaration>(Declaration.class, this, MathPackage.MATH_EXP__VARIABLES);
    }
    return variables;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MathPackage.MATH_EXP__VARIABLES:
        getVariables().clear();
        getVariables().addAll((Collection<? extends Declaration>)newValue);
        return;
    }
