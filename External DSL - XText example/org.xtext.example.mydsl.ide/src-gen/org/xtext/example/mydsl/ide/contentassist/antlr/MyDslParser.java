...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRelationAccess().getAlternatives_1_1(), "rule__Relation__Alternatives_1_1");
			builder.put(grammarAccess.getRelationAccess().getAlternatives_1_3(), "rule__Relation__Alternatives_1_3");
			...
			builder.put(grammarAccess.getEntityAccess().getAttributessAssignment_2(), "rule__Entity__AttributessAssignment_2");
			builder.put(grammarAccess.getAttributeAccess().getNameAssignment_1(), "rule__Attribute__NameAssignment_1");
			builder.put(grammarAccess.getRelationAccess().getFromAssignment_0_1(), "rule__Relation__FromAssignment_0_1");
			builder.put(grammarAccess.getRelationAccess().getToAssignment_0_3(), "rule__Relation__ToAssignment_0_3");
			builder.put(grammarAccess.getRelationAccess().getFromAssignment_1_2(), "rule__Relation__FromAssignment_1_2");
			builder.put(grammarAccess.getRelationAccess().getToAssignment_1_5(), "rule__Relation__ToAssignment_1_5");
		}
	}
