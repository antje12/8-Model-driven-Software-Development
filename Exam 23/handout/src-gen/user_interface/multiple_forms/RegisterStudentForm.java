...
public class RegisterStudentForm extends Form{
	...
	RegisterStudentForm(UserInterface parent) {
		this.parent = parent;
	...
	public JPanel createPanel1() {
		...
		personalInformation = new PersonalInformationForm(parent, "Student");
		panel.add(personalInformation.createPanel());
		universityInformation = new UniversityInformationForm(parent, 3, 10);
