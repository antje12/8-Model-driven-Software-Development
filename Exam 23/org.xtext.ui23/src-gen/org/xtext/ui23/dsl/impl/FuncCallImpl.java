 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.ui23.dsl.impl.FuncCallImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.xtext.ui23.dsl.impl.FuncCallImpl#getExps <em>Exps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FuncCallImpl extends ExpImpl implements FuncCall
{
  ...
  public EList<Exp> getExps()
  {
    if (exps == null)
    {
      exps = new EObjectContainmentEList<Exp>(Exp.class, this, DslPackage.FUNC_CALL__EXPS);
    }
    return exps;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.FUNC_CALL__EXPS:
