...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalAccess().getTypesAssignment_3_0(), "rule__External__TypesAssignment_3_0");
			builder.put(grammarAccess.getExternalAccess().getTypesAssignment_3_1_1(), "rule__External__TypesAssignment_3_1_1");
			builder.put(grammarAccess.getFunctionAccess().getFunctionAssignment_0(), "rule__Function__FunctionAssignment_0");
			builder.put(grammarAccess.getFunctionAccess().getVariablesAssignment_2_0(), "rule__Function__VariablesAssignment_2_0");
			builder.put(grammarAccess.getFunctionAccess().getVariablesAssignment_2_1_1(), "rule__Function__VariablesAssignment_2_1_1");
			...
			builder.put(grammarAccess.getPrimaryAccess().getContentAssignment_1_2(), "rule__Primary__ContentAssignment_1_2");
