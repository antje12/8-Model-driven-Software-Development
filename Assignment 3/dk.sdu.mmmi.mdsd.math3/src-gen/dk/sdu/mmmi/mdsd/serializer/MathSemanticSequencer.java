...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=ID (types+=DataType types+=DataType*)?)
	 * </pre>
	 */
	 ...
	 *     Exp returns Function
	 *     Exp.Plus_1_0_0_0 returns Function
	 *     Exp.Minus_1_0_1_0 returns Function
	 *     Factor returns Function
	 *     Factor.Mult_1_0_0_0 returns Function
	 *     Factor.Div_1_0_1_0 returns Function
	 *     Primary returns Function
	 *
	 * Constraint:
	 *     (function=[External|ID] (variables+=Exp variables+=Exp*)?)
	 * </pre>
	 */
	...
	protected void sequence_Primary(ISerializationContext context, Parenthesis semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.PARENTHESIS__CONTENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.PARENTHESIS__CONTENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPrimaryAccess().getContentExpParserRuleCall_1_2_0(), semanticObject.getContent());
		feeder.finish();
	}
